...
HTML/SGML files. The original community around SGMLReader was hosted by 
...
but this site was phased out. An archived version of the original version is 
...
the last few years we have made many improvements to this code.  In the spirit 
of the original author, we're providing back these changes in our 
[GitHub repository](https://github.com/MindTouch/SGMLReader).
...
## Community
If you have questions, please post them on [stackoverflow](http://stackoverflow.com/questions/tagged/sgmlreader)
and tag them with *sgmlreader*.

If you fix an issue, please submit follow these guiedlines:
...
1. Add a unit test to the project to confirm the fix or new behavior.
...
**BREAKING CHANGE:** requires .NET 3.5
